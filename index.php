            ...
            <div class="col-md-4 selectContainer">
              <div class="input-group">
                ...
                <select name="promo" class="form-control selectpicker">
                  ...
                  <option value="1601457151">Unli Data 499 (30 days)</option>
                  <option value="1601456308">Unli Data 599 (30 days)</option>
                  <option value="1601456749">Unli Fam 999 (30 days)</option>
                  <option value="1600822470">Magic Data 99 no Expiry 2gb</option>
                  <option value="1600822011">Magic Data 199 no Expiry 6gb</option>
                  <option value="1600822929">Magic Data 399 no Expiry 24gb</option>
                  ...
                  <option value="1600794558">Wild Rift 10 (3 days)</option>
                  <option value="1600794345">Wild Rift 50 (7 days)</option>
                </select>
              </div>
            </div>
          </div>
...
?>
      ...
      <center>SRC = JEROME LALIAG</center>
    </div>
